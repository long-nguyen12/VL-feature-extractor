...
class StandardROIHeads(ROIHeads):
    ...
    def forward(
        ...
        if self.training:
            ...
            predictions, _shared_roi_pooler, pred_instances = self._forward_box(features, proposals)
            # During inference cascaded prediction is used: the mask and keypoints heads are only
            # applied to the top scoring box detections.
            pred_instances = self.forward_with_given_boxes(features, pred_instances)
            return predictions, _shared_roi_pooler
    ...
    def _forward_box(
        ...
        _shared_roi_pooler = box_features
        ...
        if self.training:
            ...
            pred_instances, _ = self.box_predictor.inference(predictions, proposals)
            return predictions, _shared_roi_pooler, pred_instances
